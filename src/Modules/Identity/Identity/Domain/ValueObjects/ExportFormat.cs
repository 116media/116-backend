...
public record ExportFormat
{
    ...
    public ExportFormat(EnumSessionExportFormat value)
    {
        ...
        {
            throw new IdentityRuleException(IdentityRuleCodes.InvalidExportFormat, value.ToString());
        }
    ...
    public ExportFormat(string value)
    {
        ...
        {
            throw new IdentityRuleException(IdentityRuleCodes.InvalidExportFormat, value ?? string.Empty);
        }
