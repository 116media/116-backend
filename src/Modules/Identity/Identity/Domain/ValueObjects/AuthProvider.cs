...
public record AuthProvider
{
    ...
    /// </summary>
    public static implicit operator EnumAuthProvider(AuthProvider provider)
    {
    ...
    /// </summary>
    public static implicit operator string(AuthProvider provider)
    {
    ...
    /// Implicit conversion from <see cref="AuthProvider" /> to <see cref="AuthProvider" />.
    /// </summary>
    public static implicit operator AuthProvider(EnumAuthProvider provider)
    {
        return new AuthProvider(value: provider);
    }

    /// <summary>
    /// Implicit conversion from <see cref="string" /> to <see cref="AuthProvider" />.
    /// </summary>
    public static implicit operator AuthProvider(string provider)
    {
        return new AuthProvider(value: provider);
    }
}
