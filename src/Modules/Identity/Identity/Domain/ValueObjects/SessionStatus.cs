...
public record SessionStatus
{
    ...
    public SessionStatus(EnumSessionStatus value)
    {
        ...
        {
            throw new IdentityRuleException(IdentityRuleCodes.InvalidSessionStatus, value.ToString());
        }
    ...
    public SessionStatus(string value)
    {
        ...
        {
            throw new IdentityRuleException(IdentityRuleCodes.InvalidSessionStatus, value ?? string.Empty);
        }
