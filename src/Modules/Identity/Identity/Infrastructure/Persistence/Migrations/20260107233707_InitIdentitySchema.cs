...
namespace _116.Identity.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitIdentitySchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    country_dial_code = table.Column<string>(
                        type: "character varying(10)",
                        maxLength: 10,
                        nullable: true
                    ),
                    partial_phone_number = table.Column<string>(
                        type: "character varying(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    full_phone_number = table.Column<string>(
        ...
        {
            migrationBuilder.DropTable(name: "otps", schema: "identity");
