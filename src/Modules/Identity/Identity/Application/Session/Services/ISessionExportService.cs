...
public interface ISessionExportService
{
    ...
    byte[] Export(List<SessionExportDto> sessions, EnumSessionExportFormat format, List<string>? columns = null);
    ...
    string GetContentType(EnumSessionExportFormat format);
    ...
    string GenerateFileName(EnumSessionExportFormat format, string? baseFileName = null);
}
