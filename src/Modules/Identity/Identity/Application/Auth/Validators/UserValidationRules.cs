...
public static partial class UserValidationRules
{
    ...
    )
    {
        ...
        else
        {
            builder = ruleBuilder
                ...
                .WithMessage($"Email cannot exceed {UserConstants.MaxEmailLength} characters")
                .EmailAddress().WithMessage("Invalid email format")
                .When(x => !string.IsNullOrWhiteSpace(GetEmailValue(instance: x)));
        }
    ...
    )
    {
        ...
        else
        {
            builder = ruleBuilder
                ...
                .Matches(UsernameRegex())
                .WithMessage("Username can only contain letters, numbers, spaces, and hyphens")
                .When(x => !string.IsNullOrWhiteSpace(GetUsernameValue(instance: x)));
        }
    ...
    )
    {
        return ruleBuilder
            ...
            .When(x => !string.IsNullOrWhiteSpace(GetCountryNameValue(instance: x)));
    }
    ...
    )
    {
        return ruleBuilder
            ...
            .Must(predicate: BeValidUrl)
            .WithMessage("Country flag URL must be a valid URL")
            .When(x => !string.IsNullOrWhiteSpace(GetCountryFlagUrlValue(instance: x)));
    }
    ...
    )
    {
        return ruleBuilder
            ...
            .When(x => !string.IsNullOrWhiteSpace(GetCountryIsoCodeValue(instance: x)));
    }
    ...
    )
    {
        return ruleBuilder
            ...
            .When(x => !string.IsNullOrWhiteSpace(GetCountryDialCodeValue(instance: x)));
    }
    ...
    )
    {
        return ruleBuilder
            ...
            .When(x => !string.IsNullOrWhiteSpace(GetPartialPhoneNumberValue(instance: x)));
    }
    ...
    {
        return GetPropertyValue(instance: instance, "Email");
    }
    ...
    {
        return GetPropertyValue(instance: instance, "UserName");
    }
    ...
    {
        return GetPropertyValue(instance: instance, "CountryName");
    }
    ...
    {
        return GetPropertyValue(instance: instance, "CountryFlagUrl");
    }
    ...
    {
        return GetPropertyValue(instance: instance, "CountryIsoCode");
    }
    ...
    {
        return GetPropertyValue(instance: instance, "CountryDialCode");
    }
    ...
    {
        return GetPropertyValue(instance: instance, "PartialPhoneNumber");
    }
    ...
    {
        return GetPropertyValue(instance: instance, "OldPassword");
    }
    ...
    {
        return GetPropertyValue(instance: instance, "NewPassword");
    }
