...
public record AdminResetPasswordRequest(string Email, string Code, string NewPassword);

/// <summary>
/// Response model for admin password reset.
/// </summary>
/// <param name="IsSuccess">Indicates whether the password reset was successful.</param>
public record AdminResetPasswordResponse(bool IsSuccess);
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            .MapPost(
                ...
                async (AdminResetPasswordRequest request, IDispatcher dispatcher) =>
                {
                    ...
                    var response = new AdminResetPasswordResponse(IsSuccess: result.IsSuccess);
