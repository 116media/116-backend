...
/// </remarks>
public record PublicGetUserProfileQuery(
    Guid UserId
) : IQuery<PublicGetUserProfileResult>;

/// <summary>
/// Result of the <see cref="PublicGetUserProfileQuery"/> containing complete user profile data.
/// </summary>
...
/// </remarks>
public record PublicGetUserProfileResult(
