...
/// <summary>
/// Defines the password reset endpoint for admin users.
/// Handles password reset using OTP verification.
/// </summary>
public class AdminResetPasswordEndpoint : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("/reset-password", async (AdminResetPasswordRequest request, IDispatcher dispatcher) =>
            {
