...
/// <summary>
/// Singleton implementation of <see cref="IPopularTagsCacheInvalidator" /> that uses a
...
/// </summary>
/// <remarks>
/// Cache entries created by <see cref="Application.Lookup.UseCases.Public.Queries.GetPopularTags.PublicGetPopularTagsHandler" />
...
/// evict all registered entries immediately — regardless of how many distinct <c>limit</c>
/// values were used when those entries were stored. A new <see cref="CancellationTokenSource" />
