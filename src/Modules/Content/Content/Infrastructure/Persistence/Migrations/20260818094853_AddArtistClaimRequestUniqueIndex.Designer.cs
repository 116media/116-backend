...
namespace _116.Content.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260818094853_AddArtistClaimRequestUniqueIndex")]
    partial class AddArtistClaimRequestUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_116.Content.Domain.Entities.AlbumEntity", b =>
                {
                    ...
                    b.HasIndex("ArtistId", "ReleaseType")
                        .HasDatabaseName("ix_albums_artist_id_release_type");
            ...
            modelBuilder.Entity("_116.Content.Domain.Entities.ArticleArtistEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_article_artists");

                    b.HasIndex("ArtistId")
                        .HasDatabaseName("ix_article_artists_artist_id");

                    b.HasIndex("ArticleId", "ArtistId")
                        .IsUnique()
                        .HasDatabaseName("ix_article_artists_article_id_artist_id");

                    b.ToTable("article_artists", "content");
                });
            ...
            modelBuilder.Entity("_116.Content.Domain.Entities.ArtistEntity", b =>
                {
                    ...
                    b.HasIndex("NameFolded")
                        .HasDatabaseName("ix_artists_name_folded");
                    ...
                    b.HasIndex("InitialLetter", "NameFolded")
                        .HasDatabaseName("ix_artists_initial_letter_name_folded");
            ...
            modelBuilder.Entity("_116.Content.Domain.Entities.ArtistSocialLinkEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_artist_social_links");

                    b.HasIndex("ArtistId", "Platform")
                        .IsUnique()
                        .HasDatabaseName("ix_artist_social_links_artist_id_platform");

                    b.ToTable("artist_social_links", "content");
                });
            ...
            modelBuilder.Entity("_116.Content.Domain.Entities.ArticleArtistEntity", b =>
                {
                    b.HasOne("_116.Content.Domain.Entities.ArticleEntity", "Article")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_article_artists_articles_article_id");
                    ...
                    b.HasOne("_116.Content.Domain.Entities.ArtistEntity", "Artist")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_article_artists_artists_artist_id");
