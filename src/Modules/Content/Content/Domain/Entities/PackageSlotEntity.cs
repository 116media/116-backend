...
/// </summary>
public class PackageSlotEntity : Entity<Guid>
{
    /// <summary>
    ...
    internal static PackageSlotEntity Create(Guid id, Guid packageId, Guid? categoryId, bool isRequired, int quantity)
    {
        if (quantity <= 0)
        {
