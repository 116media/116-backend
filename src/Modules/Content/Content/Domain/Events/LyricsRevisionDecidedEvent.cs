...
/// <summary>
/// Raised when a lyrics-text correction revision is decided — accepted via the
...
/// <param name="LyricsId">The lyrics page the revision proposed to correct.</param>
...
public record LyricsRevisionDecidedEvent(
    Guid RevisionId,
    Guid LyricsId,
