...
namespace _116.Content.Application.Interactions.UseCases.Public.Queries.GetOwnSharedArticles.V1;

/// <summary>
/// Defines the current-user shared articles endpoint.
/// </summary>
public class PublicGetOwnSharedArticlesEndpointV1 : ICarterModule
{
    /// <inheritdoc />
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .WithName(PublicGetOwnSharedArticlesMetaField.GetOwnSharedArticles.Name)
            .WithSummary(PublicGetOwnSharedArticlesMetaField.GetOwnSharedArticles.Summary)
            .WithDescription(PublicGetOwnSharedArticlesMetaField.GetOwnSharedArticles.Description)
