...
namespace _116.Content.Application.Interactions.UseCases.Public.Commands.LikeLyrics.V1;

/// <summary>
/// Response model for a successful PublicLikeLyrics operation.
/// </summary>
/// <param name="IsSuccess">Indicates if the operation was successful.</param>
public record PublicLikeLyricsResponse(bool IsSuccess);

/// <summary>
/// Defines the like lyrics endpoint.
/// </summary>
public class PublicLikeLyricsEndpointV1 : ICarterModule
{
    /// <inheritdoc />
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .WithName(endpointName: PublicLikeLyricsMetaField.LikeLyrics.Name)
