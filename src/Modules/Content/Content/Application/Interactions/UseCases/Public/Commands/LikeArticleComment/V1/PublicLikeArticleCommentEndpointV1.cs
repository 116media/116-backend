...
namespace _116.Content.Application.Interactions.UseCases.Public.Commands.LikeArticleComment.V1;

/// <summary>
/// Response model for a successful PublicLikeArticleComment operation.
/// </summary>
/// <param name="IsSuccess">Indicates if the operation was successful.</param>
public record PublicLikeArticleCommentResponse(bool IsSuccess);

/// <summary>
/// Defines the like article comment endpoint.
/// </summary>
public class PublicLikeArticleCommentEndpointV1 : ICarterModule
{
    /// <inheritdoc />
