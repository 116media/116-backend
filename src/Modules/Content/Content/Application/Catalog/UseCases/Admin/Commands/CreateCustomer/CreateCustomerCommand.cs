...
public record CreateCustomerCommand(string FullName, string Email, string? Phone, string? Company, string? Notes)
    : ICommand<CreateCustomerResult>;

/// <summary>
/// Result of the <see cref="CreateCustomerCommand" /> containing the created customer details.
/// </summary>
/// <param name="Customer">The created customer information.</param>
public record CreateCustomerResult(CustomerDto Customer);
