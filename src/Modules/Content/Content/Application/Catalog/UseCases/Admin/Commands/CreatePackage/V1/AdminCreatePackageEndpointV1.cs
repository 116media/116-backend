...
public record AdminCreatePackageResponse(PackageDto Package);

/// <summary>
/// Defines the admin create package endpoint.
/// Handles creation of new content packages with a flat price.
/// </summary>
public class AdminCreatePackageEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminCreatePackageResponse>(statusCode: StatusCodes.Status201Created)
