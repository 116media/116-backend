...
/// </summary>
public class AdminGetAllPackagesEndpointV1 : ICarterModule
{
    /// <summary>
        ...
        group
            .MapGet(
                ...
                async (IDispatcher dispatcher, int pageIndex = 0, int pageSize = 10, bool? isActive = null) =>
                {
                    ...
                    AdminGetAllPackagesResult result = await dispatcher.Send(request: query);

                    var response = new AdminGetAllPackagesResponse(Packages: result.Packages);
                    return Results.Ok(response);
                }
            )
            .WithName(endpointName: AdminGetAllPackagesMetaField.AdminGetAllPackages.Name)
            .WithSummary(summary: AdminGetAllPackagesMetaField.AdminGetAllPackages.Summary)
            .WithDescription(description: AdminGetAllPackagesMetaField.AdminGetAllPackages.Description)
