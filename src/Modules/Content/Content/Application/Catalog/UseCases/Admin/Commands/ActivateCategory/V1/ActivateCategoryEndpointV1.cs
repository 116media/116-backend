...
/// </summary>
public class ActivateCategoryEndpointV1 : ICarterModule
{
    /// <summary>
        ...
        group
            .MapPatch(
                ...
                async (string id, IDispatcher dispatcher) =>
                {
                    ...
                    return Results.Ok(new ActivateCategoryResponse(Category: result.Category));
                }
            )
            .WithName(endpointName: ActivateCategoryMetaField.ActivateCategory.Name)
            .WithSummary(summary: ActivateCategoryMetaField.ActivateCategory.Summary)
            .WithDescription(description: ActivateCategoryMetaField.ActivateCategory.Description)
            .WithAuthorization(AccountStatusPolicies.RequireActiveUser)
            .WithAuthorization(UserRolePolicies.RequireAdminOrSuperAdmin)
            .RequireRateLimiting(policyName: RateLimitPolicies.ContentBrowsing)
            .Produces<ActivateCategoryResponse>(statusCode: StatusCodes.Status200OK)
