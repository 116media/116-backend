...
public record AdminActivateCategoryCommand(string Id) : ICommand<AdminActivateCategoryResult>;

/// <summary>
/// Result returned after successfully activating a category.
/// </summary>
/// <param name="Category">The updated category information.</param>
public record AdminActivateCategoryResult(CategoryDto Category);
