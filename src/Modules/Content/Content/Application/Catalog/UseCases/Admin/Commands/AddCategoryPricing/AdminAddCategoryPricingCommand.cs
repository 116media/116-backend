...
public record AdminAddCategoryPricingCommand(string CategoryId, Guid PricingTierId, decimal PriceUsd)
    : ICommand<AdminAddCategoryPricingResult>;

/// <summary>
/// Result of the <see cref="AdminAddCategoryPricingCommand" /> containing the created pricing details.
/// </summary>
/// <param name="Pricing">The created category pricing information.</param>
public record AdminAddCategoryPricingResult(CategoryPricingDto Pricing);
