...
public record RemoveCategoryPricingResponse(IReadOnlyList<CategoryPricingDto> Pricing, bool IsSuccess);

/// <summary>
/// Defines the admin remove category pricing endpoint.
/// Handles removal of a pricing tier from an existing category.
/// </summary>
public class RemoveCategoryPricingEndpointV1 : ICarterModule
{
    /// <summary>
        ...
        group
            .MapDelete(
                ...
                async (string id, Guid tierId, IDispatcher dispatcher) =>
                {
                    ...
                    RemoveCategoryPricingResult result = await dispatcher.Send(request: command);

                    var response = new RemoveCategoryPricingResponse(
            ...
            .WithName(endpointName: RemoveCategoryPricingMetaField.RemoveCategoryPricing.Name)
            .WithSummary(summary: RemoveCategoryPricingMetaField.RemoveCategoryPricing.Summary)
            .WithDescription(description: RemoveCategoryPricingMetaField.RemoveCategoryPricing.Description)
            .WithAuthorization(AccountStatusPolicies.RequireActiveUser)
            .WithAuthorization(UserRolePolicies.RequireSuperAdminOnly)
            .RequireRateLimiting(policyName: RateLimitPolicies.ContentBrowsing)
            .Produces<RemoveCategoryPricingResponse>(statusCode: StatusCodes.Status200OK)
