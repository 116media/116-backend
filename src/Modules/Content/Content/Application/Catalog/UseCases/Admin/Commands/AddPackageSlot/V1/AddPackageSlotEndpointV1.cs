...
public record AddPackageSlotRequest(Guid? CategoryId, bool IsRequired, int Quantity);
...
public record AddPackageSlotResponse(PackageDto Package);

/// <summary>
/// Defines the admin add package slot endpoint.
/// Handles adding a new content slot to an existing package.
/// </summary>
public class AddPackageSlotEndpointV1 : ICarterModule
{
    /// <summary>
        ...
        group
            .MapPost(
                ...
                async (Guid id, AddPackageSlotRequest request, IDispatcher dispatcher, HttpContext httpContext) =>
                {
                    ...
                    AddPackageSlotResult result = await dispatcher.Send(request: command);

                    var response = new AddPackageSlotResponse(Package: result.Package);
            ...
            .WithName(endpointName: AddPackageSlotMetaField.AddPackageSlot.Name)
            .WithSummary(summary: AddPackageSlotMetaField.AddPackageSlot.Summary)
            .WithDescription(description: AddPackageSlotMetaField.AddPackageSlot.Description)
            .WithAuthorization(AccountStatusPolicies.RequireActiveUser)
            .WithAuthorization(UserRolePolicies.RequireSuperAdminOnly)
            .RequireRateLimiting(policyName: RateLimitPolicies.ContentBrowsing)
            .ProducesValidationProblem()
            .Produces<AddPackageSlotResponse>(statusCode: StatusCodes.Status201Created)
