...
/// <summary>
/// Handles the <see cref="GetAllCustomersQuery" /> to retrieve a paginated list of customers.
/// </summary>
/// <param name="customerRepository">Repository for customer data access operations.</param>
/// <param name="mapper">Mapster mapper for entity-to-DTO transformations.</param>
public class GetAllCustomersHandler(ICustomerRepository customerRepository, IMapper mapper)
    : IQueryHandler<GetAllCustomersQuery, GetAllCustomersResult>
{
    ...
    public async Task<GetAllCustomersResult> Handle(GetAllCustomersQuery query, CancellationToken cancellationToken)
    {
        ...
        return new GetAllCustomersResult(Customers: paginatedResult);
    }
}
