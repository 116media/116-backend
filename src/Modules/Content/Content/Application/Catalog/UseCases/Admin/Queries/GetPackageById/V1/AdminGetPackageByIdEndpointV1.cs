...
public record AdminGetPackageByIdResponse(PackageDto Package);

/// <summary>
/// Defines the admin get package by ID endpoint.
/// Returns full package details including its slot composition.
/// </summary>
public class AdminGetPackageByIdEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminGetPackageByIdResponse>(statusCode: StatusCodes.Status200OK)
