...
public record AdminUpdateCustomerResponse(CustomerDto Customer);

/// <summary>
/// Defines the admin update customer endpoint.
/// Handles updating a B2B customer's contact information.
/// </summary>
public class AdminUpdateCustomerEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminUpdateCustomerResponse>(statusCode: StatusCodes.Status200OK)
