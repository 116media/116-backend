...
public record GetAllCategoriesResponse(PaginatedResult<CategoryDto> Categories);

/// <summary>
/// Defines the admin get all categories endpoint.
/// Returns a paginated list of categories with optional filters.
/// </summary>
public class GetAllCategoriesEndpointV1 : ICarterModule
{
    /// <summary>
        ...
        group
            .MapGet(
                ...
                ) =>
                {
                    ...
                    GetAllCategoriesResult result = await dispatcher.Send(request: query);

                    var response = new GetAllCategoriesResponse(Categories: result.Categories);
                    return Results.Ok(response);
                }
            )
            .WithName(endpointName: GetAllCategoriesMetaField.GetAllCategories.Name)
            .WithSummary(summary: GetAllCategoriesMetaField.GetAllCategories.Summary)
            .WithDescription(description: GetAllCategoriesMetaField.GetAllCategories.Description)
            .WithAuthorization(AccountStatusPolicies.RequireActiveUser)
            .WithAuthorization(UserRolePolicies.RequireAdminOrSuperAdmin)
            .RequireRateLimiting(policyName: RateLimitPolicies.ContentBrowsing)
            .Produces<GetAllCategoriesResponse>(statusCode: StatusCodes.Status200OK)
