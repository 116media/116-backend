...
public record AdminRemoveCategoryPricingCommand(string CategoryId, string PricingTierId)
    : ICommand<AdminRemoveCategoryPricingResult>;

/// <summary>
/// Result of the <see cref="AdminRemoveCategoryPricingCommand" /> containing the remaining pricing for the category.
/// </summary>
...
public record AdminRemoveCategoryPricingResult(IReadOnlyList<CategoryPricingDto> Pricing, bool IsSuccess);
