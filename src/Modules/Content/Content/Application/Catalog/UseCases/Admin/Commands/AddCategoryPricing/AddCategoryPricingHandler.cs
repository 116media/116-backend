...
/// <summary>
/// Handles the <see cref="AddCategoryPricingCommand" /> to attach a pricing tier to a category.
/// </summary>
...
public class AddCategoryPricingHandler(
    ICategoryRepository categoryRepository,
    ILookupRepository lookupRepository,
    IContentUnitOfWork unitOfWork,
    IMapper mapper
) : ICommandHandler<AddCategoryPricingCommand, AddCategoryPricingResult>
{
    /// <inheritdoc />
    public async Task<AddCategoryPricingResult> Handle(
        AddCategoryPricingCommand command,
    ...
    )
    {
        ...
        return new AddCategoryPricingResult(Pricing: dto);
    }
}
