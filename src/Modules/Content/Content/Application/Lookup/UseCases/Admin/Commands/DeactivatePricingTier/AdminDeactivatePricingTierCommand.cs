...
public record AdminDeactivatePricingTierCommand(string Id) : ICommand<AdminDeactivatePricingTierResult>;
...
public record AdminDeactivatePricingTierResult(PricingTierDto PricingTier);
