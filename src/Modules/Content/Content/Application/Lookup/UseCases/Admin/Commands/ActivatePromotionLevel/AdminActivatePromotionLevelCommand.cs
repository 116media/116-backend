...
public record AdminActivatePromotionLevelCommand(string Id) : ICommand<AdminActivatePromotionLevelResult>;
...
public record AdminActivatePromotionLevelResult(PromotionLevelDto PromotionLevel);
