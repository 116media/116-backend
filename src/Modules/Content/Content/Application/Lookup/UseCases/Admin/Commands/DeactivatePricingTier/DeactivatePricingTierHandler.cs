...
public class DeactivatePricingTierHandler(
    ILookupRepository lookupRepository,
    IContentUnitOfWork unitOfWork,
    IMapper mapper
) : ICommandHandler<DeactivatePricingTierCommand, DeactivatePricingTierResult>
{
    /// <inheritdoc />
    public async Task<DeactivatePricingTierResult> Handle(
        DeactivatePricingTierCommand command,
    ...
    )
    {
        ...
        return new DeactivatePricingTierResult(PricingTier: dto);
    }
}
