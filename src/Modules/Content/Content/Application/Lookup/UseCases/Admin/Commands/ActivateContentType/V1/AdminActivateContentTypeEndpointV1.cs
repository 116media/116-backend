...
public record AdminActivateContentTypeResponse(ContentTypeDto ContentType);

/// <summary>
/// Defines the admin activate content type endpoint.
/// </summary>
public class AdminActivateContentTypeEndpointV1 : ICarterModule
{
    /// <summary>
        ...
        group
            .MapPatch(
                ...
                async (string id, IDispatcher dispatcher, CancellationToken cancellationToken) =>
                {
                    ...
                    AdminActivateContentTypeResult result = await dispatcher.Send(
                        request: command,
            ...
            .WithSummary(summary: AdminActivateContentTypeMetaField.ActivateContentType.Summary)
            .WithDescription(description: AdminActivateContentTypeMetaField.ActivateContentType.Description)
            .WithAuthorization(AccountStatusPolicies.RequireActiveUser)
            .WithAuthorization(UserRolePolicies.RequireAdminOrSuperAdmin)
            .RequireRateLimiting(policyName: RateLimitPolicies.ContentManagement)
            .Produces<AdminActivateContentTypeResponse>(statusCode: StatusCodes.Status200OK)
