...
public record CreatePricingTierCommand(string Name, string? Description) : ICommand<CreatePricingTierResult>;

/// <summary>
/// Result of the <see cref="CreatePricingTierCommand" /> containing the created pricing tier details.
/// </summary>
/// <param name="PricingTier">The created pricing tier information.</param>
public record CreatePricingTierResult(PricingTierDto PricingTier);
