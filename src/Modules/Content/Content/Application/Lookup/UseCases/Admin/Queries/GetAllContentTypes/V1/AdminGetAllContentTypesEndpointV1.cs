...
public record AdminGetAllContentTypesResponse(IReadOnlyList<ContentTypeDto> ContentTypes);

/// <summary>
/// Defines the admin get all content types endpoint.
/// Returns all content types available for category assignment.
/// </summary>
public class AdminGetAllContentTypesEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminGetAllContentTypesResponse>(statusCode: StatusCodes.Status200OK)
