...
public record AdminGetAllPricingTiersResponse(IReadOnlyList<PricingTierDto> PricingTiers);

/// <summary>
/// Defines the admin get all pricing tiers endpoint.
/// Returns all pricing tiers available for category pricing configuration.
/// </summary>
public class AdminGetAllPricingTiersEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminGetAllPricingTiersResponse>(statusCode: StatusCodes.Status200OK)
