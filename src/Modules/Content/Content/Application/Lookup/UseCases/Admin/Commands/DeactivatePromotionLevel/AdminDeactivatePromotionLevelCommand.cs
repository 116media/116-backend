...
public record AdminDeactivatePromotionLevelCommand(string Id) : ICommand<AdminDeactivatePromotionLevelResult>;
...
public record AdminDeactivatePromotionLevelResult(PromotionLevelDto PromotionLevel);
