...
public record AdminDeactivateContentTypeCommand(string Id) : ICommand<AdminDeactivateContentTypeResult>;
...
public record AdminDeactivateContentTypeResult(ContentTypeDto ContentType);
