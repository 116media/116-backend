...
/// <summary>
/// Handles the <see cref="AdminActivateContentTypeCommand" /> to activate a content type.
/// </summary>
...
{
    /// <inheritdoc />
    public async Task<AdminActivateContentTypeResult> Handle(
        AdminActivateContentTypeCommand command,
    ...
    )
    {
        ...
        return new AdminActivateContentTypeResult(ContentType: dto);
    }
}
