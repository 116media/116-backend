...
public record AdminActivatePricingTierCommand(string Id) : ICommand<AdminActivatePricingTierResult>;
...
public record AdminActivatePricingTierResult(PricingTierDto PricingTier);
