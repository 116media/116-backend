...
/// When the comment is deleted, Body is null and IsDeleted is true.
/// </summary>
...
/// <param name="CreatedAt">When this comment was posted.</param>
public record ArticleCommentDto(Guid Id, Guid UserId, string? Body, bool IsDeleted, DateTime? CreatedAt);
