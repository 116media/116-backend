...
public interface ILyricsRepository : IRepository<LyricsEntity>
{
    ...
    /// <summary>
    /// Retrieves a lyrics record by its unique identifier.
    ...
    /// <param name="id">The unique identifier of the lyrics.</param>
    /// <param name="cancellationToken">Token to observe for cancellation requests.</param>
    /// <returns>The lyrics entity.</returns>
    ...
    /// <summary>
    /// Retrieves a lyrics record matching the given song title and artist name (case-insensitive).
    /// Returns null if not found.
    /// </summary>
