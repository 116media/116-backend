...
/// </summary>
public class PromotionLevelErrors(PromotionLevelErrorMessage msg)
{
    /// <summary>
    ...
    {
        return new BadRequestException(msg.DurationMustBePositive());
    }
    ...
    {
        return new BadRequestException(msg.InvalidSpotPriority());
    }
}
