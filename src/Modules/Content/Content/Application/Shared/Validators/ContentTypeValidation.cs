...
public static class ContentTypeValidation
{
    ...
    /// <param name="i18n">The content type error message provider.</param>
    ...
    )
    {
        if (isRequired)
        {
            return ruleBuilder
                ...
                .WithMessage(i18n.NameTooLong(ContentConstants.MaxContentTypeNameLength));
        }
