...
/// <summary>
/// Specification that matches a translation revision still awaiting a decision. The
/// vote-threshold auto-accept applies it in memory so the query rule and the gate cannot drift.
/// </summary>
public class PendingTranslationRevisionSpecification : Specification<LyricsTranslationRevisionEntity>
{
    /// <inheritdoc />
    public override Expression<Func<LyricsTranslationRevisionEntity, bool>> ToExpression()
    {
        return revision => revision.Status == EnumRevisionStatus.Pending;
    }
}
