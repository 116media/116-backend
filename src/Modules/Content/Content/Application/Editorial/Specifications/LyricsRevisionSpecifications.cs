...
/// <summary>
/// Specification that matches a lyrics revision still awaiting a decision. The vote-threshold
/// auto-accept applies it in memory so the query rule and the gate cannot drift.
/// </summary>
public class PendingLyricsRevisionSpecification : Specification<LyricsRevisionEntity>
{
    /// <inheritdoc />
