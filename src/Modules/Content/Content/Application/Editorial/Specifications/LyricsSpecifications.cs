...
/// <summary>
/// Specification that matches all lyrics likes belonging to a specific user.
/// </summary>
public class LyricsLikeByUserIdSpecification(Guid userId) : Specification<LyricsLikeEntity>
{
    /// <inheritdoc />
    public override Expression<Func<LyricsLikeEntity, bool>> ToExpression()
    {
...
/// <summary>
/// Specification that matches a counted lyrics view already recorded for the same deduplication
/// key within the window, which is what suppresses a repeated view from counting twice.
/// </summary>
public class LyricsCountedViewSinceSpecification(Guid lyricsId, string dedupKey, DateTime since)
    : Specification<LyricsViewEventEntity>
{
    /// <inheritdoc />
    public override Expression<Func<LyricsViewEventEntity, bool>> ToExpression()
    {
        return viewEvent =>
            viewEvent.LyricsId == lyricsId
