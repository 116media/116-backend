...
/// <summary>
/// Specification that matches all comment likes belonging to a specific user.
/// </summary>
public class ArticleCommentLikeByUserIdSpecification(Guid userId) : Specification<ArticleCommentLikeEntity>
{
    /// <inheritdoc />
    public override Expression<Func<ArticleCommentLikeEntity, bool>> ToExpression()
    {
