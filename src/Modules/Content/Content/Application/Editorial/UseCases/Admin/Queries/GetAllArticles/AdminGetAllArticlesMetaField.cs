...
/// <summary>
/// Contains metadata information for the admin get all articles route.
/// </summary>
public static class AdminGetAllArticlesMetaField
{
    public static readonly RouteMetadata AdminGetAllArticles = new(
        "AdminGetAllArticles",
        "List all articles",
        """
