...
public record UpdateLyricsCommand(string Id, string LyricsText) : ICommand<UpdateLyricsResult>;

/// <summary>
/// Result of the <see cref="UpdateLyricsCommand" /> containing the updated lyrics details.
/// </summary>
/// <param name="Lyrics">The updated lyrics information.</param>
public record UpdateLyricsResult(LyricsDto Lyrics);
