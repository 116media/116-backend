...
public record CreateArticleRequest(Guid CategoryId, string Title, string Slug, Guid? CustomerId, Guid? OrderItemId);

/// <summary>
/// Response model for successful article draft creation.
/// </summary>
/// <param name="Article">The created article detail information.</param>
public record CreateArticleResponse(ArticleDetailDto Article);
...
/// </summary>
public class CreateArticleEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            .MapPost(
                "/",
                async (CreateArticleRequest request, IDispatcher dispatcher, HttpContext httpContext) =>
                {
                    ...
                    CreateArticleResult result = await dispatcher.Send(request: command);

                    var response = new CreateArticleResponse(Article: result.Article);
            ...
            .WithName(endpointName: CreateArticleMetaField.CreateArticle.Name)
            .WithSummary(summary: CreateArticleMetaField.CreateArticle.Summary)
            .WithDescription(description: CreateArticleMetaField.CreateArticle.Description)
            .WithAuthorization(AccountStatusPolicies.RequireActiveUser)
            .WithAuthorization(UserRolePolicies.RequireSuperAdminOnly)
            .RequireRateLimiting(policyName: RateLimitPolicies.ContentBrowsing)
            .ProducesValidationProblem()
            .Produces<CreateArticleResponse>(statusCode: StatusCodes.Status201Created)
