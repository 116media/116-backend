...
/// <summary>
/// Handles the <see cref="UpdateArticleTagsCommand" /> to replace all tags on an article.
...
public class UpdateArticleTagsHandler(
    IArticleRepository articleRepository,
    ILookupRepository lookupRepository,
    IContentUnitOfWork unitOfWork
) : ICommandHandler<UpdateArticleTagsCommand>
{
    /// <inheritdoc />
    public async Task Handle(UpdateArticleTagsCommand command, CancellationToken cancellationToken)
    {
