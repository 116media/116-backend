...
public record UploadShortVideoThumbnailResponse(string ThumbnailUrl, string ThumbnailStorageKey);

/// <summary>
/// Defines the admin upload short video thumbnail endpoint.
/// Handles thumbnail image upload for an existing short video.
/// </summary>
public class UploadShortVideoThumbnailEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            .MapPost(
                ...
                {
                    var command = new UploadShortVideoThumbnailCommand(ShortVideoId: id, File: file);
                    UploadShortVideoThumbnailResult result = await dispatcher.Send(request: command);

                    var response = new UploadShortVideoThumbnailResponse(
            ...
            .WithName(endpointName: UploadShortVideoThumbnailMetaField.UploadShortVideoThumbnail.Name)
            .WithSummary(summary: UploadShortVideoThumbnailMetaField.UploadShortVideoThumbnail.Summary)
            .WithDescription(description: UploadShortVideoThumbnailMetaField.UploadShortVideoThumbnail.Description)
            .WithAuthorization(AccountStatusPolicies.RequireActiveUser)
            .WithAuthorization(UserRolePolicies.RequireAdminOrSuperAdmin)
            .RequireRateLimiting(policyName: RateLimitPolicies.FileUpload)
            .DisableAntiforgery()
            .ProducesValidationProblem()
            .Produces<UploadShortVideoThumbnailResponse>(statusCode: StatusCodes.Status200OK)
