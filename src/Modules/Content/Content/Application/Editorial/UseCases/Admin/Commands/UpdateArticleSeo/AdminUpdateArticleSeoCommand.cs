...
public record AdminUpdateArticleSeoCommand(string Id, string? MetaTitle, string? MetaDescription)
    : ICommand<AdminUpdateArticleSeoResult>;

/// <summary>
/// Result of the <see cref="AdminUpdateArticleSeoCommand" /> containing the updated article details.
/// </summary>
/// <param name="Article">The updated article detail information.</param>
public record AdminUpdateArticleSeoResult(ArticleDetailDto Article);
