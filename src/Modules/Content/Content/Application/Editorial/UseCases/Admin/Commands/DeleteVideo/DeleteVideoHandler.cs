...
/// <summary>
/// Handles the <see cref="DeleteVideoCommand" /> to permanently delete a draft or rejected video.
...
) : ICommandHandler<DeleteVideoCommand>
{
    /// <inheritdoc />
    public async Task Handle(DeleteVideoCommand command, CancellationToken cancellationToken)
    {
