...
/// <summary>
/// Command for creating a new short video draft. The video file is uploaded separately
/// afterwards via the dedicated upload endpoint. Optionally links the short video as a teaser
/// for an existing full video.
/// </summary>
...
public record AdminCreateShortVideoCommand(string Title, string Slug, Guid AuthorId, Guid? VideoId)
