...
/// <summary>
/// Response model for a successful ApproveArticle operation.
/// </summary>
/// <param name="IsSuccess">Indicates if the operation was successful.</param>
public record AdminApproveArticleResponse(bool IsSuccess);

/// <summary>
/// Defines the admin approve article endpoint.
/// Handles transitioning an article from PendingReview to Approved.
/// </summary>
public class AdminApproveArticleEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            .MapPatch(
                ...
                {
                    var command = new AdminApproveArticleCommand(Id: id);
                    AdminApproveArticleResult result = await dispatcher.Send(request: command);

                    var response = new AdminApproveArticleResponse(IsSuccess: result.IsSuccess);
            ...
            .Produces<AdminApproveArticleResponse>(statusCode: StatusCodes.Status200OK)
