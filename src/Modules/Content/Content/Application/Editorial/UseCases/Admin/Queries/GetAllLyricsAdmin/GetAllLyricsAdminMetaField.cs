...
/// <summary>
/// Contains metadata information for the get all lyrics admin route.
/// </summary>
public static class GetAllLyricsAdminMetaField
{
    public static readonly RouteMetadata GetAllLyricsAdmin = new(
        "GetAllLyricsAdmin",
