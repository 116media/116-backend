...
/// <summary>
/// Handles the <see cref="CreateLyricsCommand" /> to create a new lyrics page.
/// </summary>
/// <param name="lyricsRepository">Repository for lyrics data access operations.</param>
/// <param name="unitOfWork">Unit of Work for managing database transactions.</param>
/// <param name="mapper">Mapster mapper for entity-to-DTO transformations.</param>
public class CreateLyricsHandler(ILyricsRepository lyricsRepository, IContentUnitOfWork unitOfWork, IMapper mapper)
    : ICommandHandler<CreateLyricsCommand, CreateLyricsResult>
{
    /// <inheritdoc />
    public async Task<CreateLyricsResult> Handle(CreateLyricsCommand command, CancellationToken cancellationToken)
    {
        ...
        return new CreateLyricsResult(Lyrics: dto);
    }
}
