...
public record AdminCreateVideoResponse(VideoDetailDto Video);

/// <summary>
/// Defines the admin create video endpoint.
/// Handles creation of new video drafts (step 1 of the video creation flow).
/// </summary>
public class AdminCreateVideoEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            .MapPost(
                "/",
                async (
                    AdminCreateVideoRequest request,
            ...
            .Produces<AdminCreateVideoResponse>(statusCode: StatusCodes.Status201Created)
