...
public record AdminRejectVideoRequest(string Reason);

/// <summary>
/// Response model for a successful RejectVideo operation.
/// </summary>
/// <param name="IsSuccess">Indicates if the operation was successful.</param>
public record AdminRejectVideoResponse(bool IsSuccess);

/// <summary>
/// Defines the admin reject video endpoint.
/// Handles transitioning a video from PendingReview to Rejected.
/// </summary>
public class AdminRejectVideoEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminRejectVideoResponse>(statusCode: StatusCodes.Status200OK)
