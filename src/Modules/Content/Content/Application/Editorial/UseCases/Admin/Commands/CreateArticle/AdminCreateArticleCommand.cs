...
public record AdminCreateArticleCommand(
    ...
    Guid? CustomerId,
    Guid? OrderItemId
) : ICommand<AdminCreateArticleResult>;

/// <summary>
/// Result of the <see cref="AdminCreateArticleCommand" /> containing the newly created article details.
/// </summary>
/// <param name="Article">The created article detail information.</param>
public record AdminCreateArticleResult(ArticleDetailDto Article);
