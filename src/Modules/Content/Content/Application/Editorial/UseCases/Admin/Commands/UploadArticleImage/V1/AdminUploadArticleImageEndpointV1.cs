...
public record AdminUploadArticleImageResponse(ArticleImageDto Image);

/// <summary>
/// Defines the admin upload article image endpoint.
/// Handles uploading cover and body images for an article.
/// </summary>
public class AdminUploadArticleImageEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminUploadArticleImageResponse>(statusCode: StatusCodes.Status201Created)
