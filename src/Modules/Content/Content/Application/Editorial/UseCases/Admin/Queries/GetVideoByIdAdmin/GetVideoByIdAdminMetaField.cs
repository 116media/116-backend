...
/// <summary>
/// Contains metadata information for the get video by id admin route.
/// </summary>
public static class GetVideoByIdAdminMetaField
{
    public static readonly RouteMetadata GetVideoByIdAdmin = new(
        "GetVideoByIdAdmin",
