...
/// <summary>
/// Handles the <see cref="UploadVideoThumbnailCommand" /> to upload or replace a video thumbnail.
...
public class UploadVideoThumbnailHandler(
    IVideoRepository videoRepository,
    IContentUnitOfWork unitOfWork,
    ICloudinaryService cloudinaryService
) : ICommandHandler<UploadVideoThumbnailCommand, UploadVideoThumbnailResult>
{
    /// <inheritdoc />
    public async Task<UploadVideoThumbnailResult> Handle(
        UploadVideoThumbnailCommand command,
    ...
    )
    {
        ...
        return new UploadVideoThumbnailResult(ThumbnailUrl: result.SecureUrl, ThumbnailStorageKey: result.PublicId);
    }
}
