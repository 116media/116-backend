...
public record AdminUpdateArticleSeoRequest(string? MetaTitle, string? MetaDescription);

/// <summary>
/// Response model for successful article SEO update.
/// </summary>
/// <param name="Article">The updated article detail information.</param>
public record AdminUpdateArticleSeoResponse(ArticleDetailDto Article);

/// <summary>
/// Defines the admin update article SEO endpoint.
/// Handles updating an article's SEO metadata fields.
/// </summary>
public class AdminUpdateArticleSeoEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminUpdateArticleSeoResponse>(statusCode: StatusCodes.Status200OK)
