...
public record CreateLyricsResponse(LyricsDto Lyrics);

/// <summary>
/// Defines the admin create lyrics endpoint.
/// Handles creation of new lyrics pages.
/// </summary>
public class CreateLyricsEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            .MapPost(
                "/",
                async (CreateLyricsRequest request, IDispatcher dispatcher, HttpContext httpContext) =>
                {
                    var command = new CreateLyricsCommand(
                    ...
                    CreateLyricsResult result = await dispatcher.Send(request: command);

                    var response = new CreateLyricsResponse(Lyrics: result.Lyrics);
            ...
            .WithName(endpointName: CreateLyricsMetaField.CreateLyrics.Name)
            .WithSummary(summary: CreateLyricsMetaField.CreateLyrics.Summary)
            .WithDescription(description: CreateLyricsMetaField.CreateLyrics.Description)
            .WithAuthorization(AccountStatusPolicies.RequireActiveUser)
            .WithAuthorization(UserRolePolicies.RequireSuperAdminOnly)
            .RequireRateLimiting(policyName: RateLimitPolicies.ContentBrowsing)
            .ProducesValidationProblem()
            .Produces<CreateLyricsResponse>(statusCode: StatusCodes.Status201Created)
