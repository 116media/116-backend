...
public record AdminDeleteArticleCommand(string Id) : ICommand<AdminDeleteArticleResult>;

/// <summary>
/// Result of the <see cref="AdminDeleteArticleCommand" /> indicating whether the operation succeeded.
/// </summary>
/// <param name="IsSuccess">Indicates if the operation was successful.</param>
public record AdminDeleteArticleResult(bool IsSuccess);
