...
/// </summary>
public class ArchiveVideoEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            .MapPatch(
                ...
                {
                    var command = new ArchiveVideoCommand(Id: id);
                    await dispatcher.Send(request: command);
                    return Results.NoContent();
                }
            )
            .WithName(endpointName: ArchiveVideoMetaField.ArchiveVideo.Name)
            .WithSummary(summary: ArchiveVideoMetaField.ArchiveVideo.Summary)
            .WithDescription(description: ArchiveVideoMetaField.ArchiveVideo.Description)
