...
public record AdminUpdateVideoSeoRequest(string? MetaTitle, string? MetaDescription);

/// <summary>
/// Response model for successful video SEO update.
/// </summary>
/// <param name="Video">The updated video detail information.</param>
public record AdminUpdateVideoSeoResponse(VideoDetailDto Video);

/// <summary>
/// Defines the admin update video SEO endpoint.
/// Handles updating a video's SEO metadata fields.
/// </summary>
public class AdminUpdateVideoSeoEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminUpdateVideoSeoResponse>(statusCode: StatusCodes.Status200OK)
