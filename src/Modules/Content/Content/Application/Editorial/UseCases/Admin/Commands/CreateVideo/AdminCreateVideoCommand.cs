...
public record AdminCreateVideoCommand(
    Guid CategoryId,
    string Title,
    string Slug,
    Guid AuthorId,
...
) : ICommand<AdminCreateVideoResult>;

/// <summary>
/// Result of the <see cref="AdminCreateVideoCommand" /> containing the newly created video details.
/// </summary>
/// <param name="Video">The created video detail information.</param>
public record AdminCreateVideoResult(VideoDetailDto Video);
