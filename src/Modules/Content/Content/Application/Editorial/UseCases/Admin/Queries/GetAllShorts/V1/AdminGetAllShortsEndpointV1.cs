...
namespace _116.Content.Application.Editorial.UseCases.Admin.Queries.GetAllShorts.V1;
...
public record AdminGetAllShortsResponse(PaginatedResult<ShortVideoDto> ShortVideos);

/// <summary>
/// Defines the admin get all short videos endpoint.
/// Returns a paginated list of short videos with optional filters.
/// </summary>
public class AdminGetAllShortsEndpointV1 : ICarterModule
{
    /// <summary>
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<AdminGetAllShortsResponse>(statusCode: StatusCodes.Status200OK)
