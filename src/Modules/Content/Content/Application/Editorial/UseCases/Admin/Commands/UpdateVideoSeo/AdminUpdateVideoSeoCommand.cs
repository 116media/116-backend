...
public record AdminUpdateVideoSeoCommand(string Id, string? MetaTitle, string? MetaDescription)
    : ICommand<AdminUpdateVideoSeoResult>;

/// <summary>
/// Result of the <see cref="AdminUpdateVideoSeoCommand" /> containing the updated video details.
/// </summary>
/// <param name="Video">The updated video detail information.</param>
public record AdminUpdateVideoSeoResult(VideoDetailDto Video);
