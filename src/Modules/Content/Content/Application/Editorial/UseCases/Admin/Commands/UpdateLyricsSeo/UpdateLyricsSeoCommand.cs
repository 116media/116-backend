...
public record UpdateLyricsSeoCommand(
    string Id,
    string? MetaTitle,
    string? MetaDescription,
    string? MetaKeywords,
    string? StructuredData
) : ICommand<UpdateLyricsSeoResult>;

/// <summary>
/// Result of the <see cref="UpdateLyricsSeoCommand" /> containing the updated lyrics details.
/// </summary>
/// <param name="Lyrics">The updated lyrics information.</param>
public record UpdateLyricsSeoResult(LyricsDto Lyrics);
