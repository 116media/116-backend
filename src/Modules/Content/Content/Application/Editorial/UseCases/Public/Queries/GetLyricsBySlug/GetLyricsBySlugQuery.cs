...
public record GetLyricsBySlugQuery(string SongTitle, string ArtistName) : IQuery<GetLyricsBySlugResult>;

/// <summary>
/// Result of the <see cref="GetLyricsBySlugQuery" /> containing the matching lyrics page.
/// </summary>
/// <param name="Lyrics">The matched lyrics information.</param>
public record GetLyricsBySlugResult(LyricsDto Lyrics);
