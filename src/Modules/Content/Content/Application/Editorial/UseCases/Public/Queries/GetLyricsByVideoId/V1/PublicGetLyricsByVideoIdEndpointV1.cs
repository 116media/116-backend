...
public record PublicGetLyricsByVideoIdResponse(LyricsDto Lyrics);
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group
            .MapGet(
                ...
                async (string videoId, IDispatcher dispatcher) =>
                {
                    var query = new PublicGetLyricsByVideoIdQuery(VideoId: videoId);
