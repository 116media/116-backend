...
public record ArticlePromotionEntryDto(PublicArticleSummaryDto Article);
...
public record ArticlePromotionSlotDto(string Position, IReadOnlyList<PublicArticleSummaryDto> Articles);
...
public record ArticlePromotionSpotDto(int SpotPriority, IReadOnlyList<PublicArticleSummaryDto> Articles);
