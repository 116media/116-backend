...
public record GetArticleBySlugQuery(string Slug) : IQuery<GetArticleBySlugResult>;

/// <summary>
/// Result of the <see cref="GetArticleBySlugQuery" /> containing the full article details.
/// </summary>
/// <param name="Article">The detailed article information.</param>
public record GetArticleBySlugResult(ArticleDetailDto Article);
