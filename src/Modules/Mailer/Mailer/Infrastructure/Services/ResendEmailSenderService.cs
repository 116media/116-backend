...
/// <summary>
/// Resend HTTP API implementation of <see cref="IEmailSenderService" /> — a typed
...
public class ResendEmailSenderService(HttpClient httpClient) : IEmailSenderService
{
    /// <summary>
    ...
    {
        string baseUrl = MailEnv.ResendApiUrl.Value.TrimEnd('/');
        string apiKey = MailEnv.ResendApiKey.Value!;
