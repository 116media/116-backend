...
/// </summary>
public class ResendEmailSenderServiceTests : IDisposable
{
    /// <summary>
    ...
    private static ResendEmailSenderService CreateSender(string baseUrl)
    {
        Environment.SetEnvironmentVariable("RESEND_API_URL", baseUrl);
        Environment.SetEnvironmentVariable("RESEND_API_KEY", "re_test_key");
        ...
        return new ResendEmailSenderService(new HttpClient());
    }
