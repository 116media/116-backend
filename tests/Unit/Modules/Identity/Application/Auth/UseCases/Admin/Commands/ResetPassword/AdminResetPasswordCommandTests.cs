...
/// <summary>
/// Unit tests for <see cref="AdminResetPasswordCommand"/> verifying it opts into per-account
/// throttling under the password-management policy, keyed by the email.
/// </summary>
public class AdminResetPasswordCommandTests
{
    [Fact]
    public void OptsIntoPasswordManagementThrottling_KeyedByEmail()
    {
        const string email = "admin@example.com";
        var command = new AdminResetPasswordCommand(email, "123456", "NewPassword1!");
