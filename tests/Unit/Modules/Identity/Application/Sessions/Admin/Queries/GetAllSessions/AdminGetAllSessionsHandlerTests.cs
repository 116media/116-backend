...
namespace _116.Unit.Tests.Modules.Identity.Application.Sessions.Admin.Queries.GetAllSessions;

/// <summary>
/// Unit tests for <see cref="AdminGetAllSessionsHandler"/>.
/// </summary>
public class AdminGetAllSessionsHandlerTests
{
    ...
    public AdminGetAllSessionsHandlerTests()
    {
        ...
        _handler = new AdminGetAllSessionsHandler(_sessionRepositoryMock.Object);
    }
