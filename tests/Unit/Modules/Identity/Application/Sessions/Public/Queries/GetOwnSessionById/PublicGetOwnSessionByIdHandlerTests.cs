...
namespace _116.Unit.Tests.Modules.Identity.Application.Sessions.Public.Queries.GetOwnSessionById;

/// <summary>
/// Unit tests for <see cref="PublicGetOwnSessionByIdHandler"/>.
/// </summary>
public class PublicGetOwnSessionByIdHandlerTests
{
    private readonly Mock<ISessionRepository> _sessionRepositoryMock;
    private readonly PublicGetOwnSessionByIdHandler _handler;

    public PublicGetOwnSessionByIdHandlerTests()
    {
        _sessionRepositoryMock = MockSessionRepository.Create();
        _handler = new PublicGetOwnSessionByIdHandler(_sessionRepositoryMock.Object);
    }
