...
namespace _116.Unit.Tests.Modules.Identity.Application.Sessions.Public.Queries.GetOwnSessions;

/// <summary>
/// Unit tests for <see cref="PublicGetOwnSessionsHandler"/>.
/// </summary>
public class PublicGetOwnSessionsHandlerTests
{
    ...
    public PublicGetOwnSessionsHandlerTests()
    {
        ...
        _handler = new PublicGetOwnSessionsHandler(_sessionRepositoryMock.Object);
    }
