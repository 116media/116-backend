...
namespace _116.Unit.Tests.Modules.Identity.Application.Permissions.Admin.Commands.ActivatePermission;

/// <summary>
/// Unit tests for <see cref="AdminActivatePermissionHandler"/>.
/// </summary>
public class AdminActivatePermissionHandlerTests
{
    ...
    public AdminActivatePermissionHandlerTests()
    {
        ...
        _handler = new AdminActivatePermissionHandler(_permissionRepositoryMock.Object, _unitOfWorkMock.Object);
    }
    ...
    public async Task Handle_WhenPermissionNotFound_ShouldThrowNotFoundException()
    {
        ...
        AdminActivatePermissionCommand command = new(PermissionId: nonExistentPermissionId);
