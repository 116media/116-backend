...
namespace _116.Unit.Tests.Modules.Identity.Application.Permissions.Admin.Commands.RestorePermission;

/// <summary>
/// Unit tests for <see cref="AdminRestorePermissionHandler"/>.
/// </summary>
public class AdminRestorePermissionHandlerTests
{
    ...
    public AdminRestorePermissionHandlerTests()
    {
        ...
        _handler = new AdminRestorePermissionHandler(_permissionRepositoryMock.Object, _unitOfWorkMock.Object);
    }
