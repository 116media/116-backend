...
namespace _116.Unit.Tests.Modules.Identity.Application.Permissions.Admin.Queries.GetAllPermissions;

/// <summary>
/// Unit tests for <see cref="AdminGetAllPermissionsHandler"/>.
/// </summary>
public class AdminGetAllPermissionsHandlerTests
{
    ...
    public AdminGetAllPermissionsHandlerTests()
    {
        ...
        _handler = new AdminGetAllPermissionsHandler(_permissionRepositoryMock.Object);
    }
