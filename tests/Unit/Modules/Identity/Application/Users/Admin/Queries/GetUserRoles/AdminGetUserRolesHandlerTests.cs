...
namespace _116.Unit.Tests.Modules.Identity.Application.Users.Admin.Queries.GetUserRoles;
...
public class AdminGetUserRolesHandlerTests
{
    ...
    public async Task Handle_WithUserRoles_ShouldReturnRoleDtos()
    {
        ...
        List<UserRoleEntity> userRoles = [CreateUserRoleWithRole(userId, role1), CreateUserRoleWithRole(userId, role2)];
    ...
    public async Task Handle_ShouldMapRolesToDtos()
    {
        ...
        List<UserRoleEntity> userRoles = [CreateUserRoleWithRole(userId, role)];
