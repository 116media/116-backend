...
namespace _116.Unit.Tests.Modules.Identity.Application.Users.Admin.Commands.RemoveRoleFromUser;
...
public class AdminRemoveRoleFromUserHandlerTests
{
    ...
    public async Task Handle_WithValidRequest_ShouldReturnRemainingRoles()
    {
        ...
        UserRoleEntity userRole = CreateUserRoleWithRole(userId, roleToRemove);
        UserRoleEntity remainingUserRole = CreateUserRoleWithRole(userId, remainingRole);
    ...
    public async Task Handle_ShouldGetUserRoleAssociation()
    {
        ...
        UserRoleEntity userRole = CreateUserRoleWithRole(userId, role);
    ...
    private static UserRoleEntity CreateUserRoleWithRole(Guid userId, RoleEntity role)
    {
        UserRoleEntity userRole = UserRoleEntity.Create(Guid.NewGuid(), userId, role.Id);
