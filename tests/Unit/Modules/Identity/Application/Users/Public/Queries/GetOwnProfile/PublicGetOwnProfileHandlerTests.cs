...
namespace _116.Unit.Tests.Modules.Identity.Application.Users.Public.Queries.GetOwnProfile;

/// <summary>
/// Unit tests for <see cref="PublicGetOwnProfileHandler"/>.
/// </summary>
public class PublicGetOwnProfileHandlerTests
{
    ...
    public PublicGetOwnProfileHandlerTests()
    {
        ...
        _handler = new PublicGetOwnProfileHandler(
