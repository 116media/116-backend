...
namespace _116.Unit.Tests.Modules.Identity.Application.Users.Public.Commands.UpdateAvatar;

/// <summary>
/// Unit tests for <see cref="PublicUpdateAvatarHandler"/>.
/// </summary>
public class PublicUpdateAvatarHandlerTests
{
    ...
    public PublicUpdateAvatarHandlerTests()
    {
        ...
        _handler = new PublicUpdateAvatarHandler(_authFactoryMock.Object, _fileRepositoryMock.Object);
    }
