...
namespace _116.Unit.Tests.Modules.Identity.Application.Users.Public.Commands.UpdateOwnProfile;

/// <summary>
/// Unit tests for <see cref="PublicUpdateOwnProfileHandler"/>.
/// </summary>
public class PublicUpdateOwnProfileHandlerTests
{
    ...
    public PublicUpdateOwnProfileHandlerTests()
    {
        ...
        _handler = new PublicUpdateOwnProfileHandler(_authFactoryMock.Object, _fileRepositoryMock.Object);
    }
