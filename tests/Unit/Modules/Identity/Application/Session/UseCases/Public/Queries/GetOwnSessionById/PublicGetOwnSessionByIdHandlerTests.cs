...
/// </summary>
public class PublicGetOwnSessionByIdHandlerTests : BaseHandlerTest
{
    ...
    public PublicGetOwnSessionByIdHandlerTests()
    {
        ...
        _handler = new PublicGetOwnSessionByIdHandler(_sessionRepositoryMock.Object, Mapper, sessionErrors);
    }
