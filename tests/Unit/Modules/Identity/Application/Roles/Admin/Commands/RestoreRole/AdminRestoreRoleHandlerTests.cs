...
namespace _116.Unit.Tests.Modules.Identity.Application.Roles.Admin.Commands.RestoreRole;

/// <summary>
/// Unit tests for <see cref="AdminRestoreRoleHandler"/>.
/// </summary>
public class AdminRestoreRoleHandlerTests
{
    ...
    public AdminRestoreRoleHandlerTests()
    {
        ...
        _handler = new AdminRestoreRoleHandler(_roleRepositoryMock.Object, _unitOfWorkMock.Object);
    }
