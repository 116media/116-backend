...
/// <summary>
/// Unit tests for <see cref="AdminDeactivatePermissionValidator"/>.
/// </summary>
public class AdminDeactivatePermissionValidatorTests
{
    private readonly AdminDeactivatePermissionValidator _validator = new(TestErrorsFactory.CreateIdentityI18n());
    ...
    {
        AdminDeactivatePermissionCommand command = new(PermissionId: Guid.NewGuid().ToString());
    ...
    {
        AdminDeactivatePermissionCommand command = new(PermissionId: Guid.NewGuid().ToString().ToLowerInvariant());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminDeactivatePermissionCommand command = new(PermissionId: Guid.NewGuid().ToString().ToUpperInvariant());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminDeactivatePermissionCommand command = new(PermissionId: Guid.Empty.ToString());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminDeactivatePermissionCommand command = new(PermissionId: null!);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
            .ContainSingle(e =>
                e.PropertyName == nameof(AdminDeactivatePermissionCommand.PermissionId)
    ...
    {
        AdminDeactivatePermissionCommand command = new(PermissionId: string.Empty);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
    ...
    {
        AdminDeactivatePermissionCommand command = new(PermissionId: "   ");
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
    ...
    {
        AdminDeactivatePermissionCommand command = new(PermissionId: invalidGuid);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
