...
/// <summary>
/// Unit tests for <see cref="AdminHardDeletePermissionValidator"/>.
/// </summary>
public class AdminHardDeletePermissionValidatorTests
{
    private readonly AdminHardDeletePermissionValidator _validator = new(TestErrorsFactory.CreateIdentityI18n());
    ...
    {
        AdminHardDeletePermissionCommand command = new(PermissionId: Guid.NewGuid().ToString());
    ...
    {
        AdminHardDeletePermissionCommand command = new(PermissionId: Guid.NewGuid().ToString().ToLowerInvariant());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminHardDeletePermissionCommand command = new(PermissionId: Guid.NewGuid().ToString().ToUpperInvariant());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminHardDeletePermissionCommand command = new(PermissionId: Guid.Empty.ToString());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminHardDeletePermissionCommand command = new(PermissionId: null!);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
            .ContainSingle(e =>
                e.PropertyName == nameof(AdminHardDeletePermissionCommand.PermissionId)
    ...
    {
        AdminHardDeletePermissionCommand command = new(PermissionId: string.Empty);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
    ...
    {
        AdminHardDeletePermissionCommand command = new(PermissionId: "   ");
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
    ...
    {
        AdminHardDeletePermissionCommand command = new(PermissionId: invalidGuid);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
