...
/// <summary>
/// Unit tests for <see cref="AdminRestoreRoleValidator"/>.
/// </summary>
public class AdminRestoreRoleValidatorTests
{
    private readonly AdminRestoreRoleValidator _validator = new(TestErrorsFactory.CreateIdentityI18n());
    ...
    {
        AdminRestoreRoleCommand command = new(RoleId: Guid.NewGuid().ToString());
    ...
    {
        AdminRestoreRoleCommand command = new(RoleId: Guid.NewGuid().ToString().ToLowerInvariant());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminRestoreRoleCommand command = new(RoleId: Guid.NewGuid().ToString().ToUpperInvariant());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminRestoreRoleCommand command = new(RoleId: Guid.Empty.ToString());
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        AdminRestoreRoleCommand command = new(RoleId: null!);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
            .ContainSingle(e =>
                e.PropertyName == nameof(AdminRestoreRoleCommand.RoleId)
    ...
    {
        AdminRestoreRoleCommand command = new(RoleId: string.Empty);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
    ...
    {
        AdminRestoreRoleCommand command = new(RoleId: "   ");
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
    ...
    {
        AdminRestoreRoleCommand command = new(RoleId: invalidGuid);
        ValidationResult result = await _validator.ValidateAsync(command);
        result.IsValid.Should().BeFalse();
        result
            .Errors.Should()
