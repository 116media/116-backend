...
public class VisitorPermissionsTests
{
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetContent();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetProfile();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetLikes();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetComments();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetBookmarks();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetNavigation();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetPlaylists();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetAds();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetRates();
    ...
    {
        // Act
        PermissionEntity[] permissions = VisitorPermissions.GetShares();
