...
/// <summary>
/// Unit tests for <see cref="PopularTagsCacheInvalidator"/>.
...
/// </summary>
public class PopularTagsCacheInvalidatorTests
{
    private readonly PopularTagsCacheInvalidator _invalidator = new();
