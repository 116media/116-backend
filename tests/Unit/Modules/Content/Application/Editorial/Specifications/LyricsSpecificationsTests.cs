...
public class LyricsSpecificationsTests
{
    ...
    #region LyricsLikeByUserIdSpecification

    [Fact]
    public void LyricsLikeByUserIdSpecification_WithMatchingUser_ShouldReturnTrue()
    {
        // Arrange
        Guid userId = Guid.NewGuid();
        LyricsLikeEntity like = LyricsLikeEntity.Create(id: Guid.NewGuid(), userId: userId, lyricsId: Guid.NewGuid());
        var spec = new LyricsLikeByUserIdSpecification(userId: userId);
    ...
    [Fact]
    public void LyricsLikeByUserIdSpecification_WithDifferentUser_ShouldReturnFalse()
    {
        // Arrange
        LyricsLikeEntity like = LyricsLikeEntity.Create(
            id: Guid.NewGuid(),
            userId: Guid.NewGuid(),
            lyricsId: Guid.NewGuid()
        );
        var spec = new LyricsLikeByUserIdSpecification(userId: Guid.NewGuid());
    ...
    #region LyricsCountedViewSinceSpecification

    [Fact]
    public void LyricsCountedViewSinceSpecification_WithCountedViewInWindow_ShouldReturnTrue()
    {
        // Arrange
        Guid lyricsId = Guid.NewGuid();
    ...
    [Fact]
    public void LyricsCountedViewSinceSpecification_WithUncountedView_ShouldReturnFalse()
    {
        // Arrange
        Guid lyricsId = Guid.NewGuid();
    ...
    [Fact]
    public void LyricsCountedViewSinceSpecification_WithViewOlderThanWindow_ShouldReturnFalse()
    {
        // Arrange
        Guid lyricsId = Guid.NewGuid();
        LyricsViewEventEntity viewEvent = LyricsViewEventFactory.CreateCounted(lyricsId, "dedup-key");
    ...
    [Fact]
    public void LyricsCountedViewSinceSpecification_WithDifferentDedupKey_ShouldReturnFalse()
    {
        // Arrange
        Guid lyricsId = Guid.NewGuid();
        LyricsViewEventEntity viewEvent = LyricsViewEventFactory.CreateCounted(lyricsId, "dedup-key");
