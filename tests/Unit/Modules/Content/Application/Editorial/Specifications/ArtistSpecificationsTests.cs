...
public class ArtistSpecificationsTests
{
    ...
    #region ArtistByInitialLetterSpecification

    [Fact]
    public void ArtistByInitialLetterSpecification_WithMatchingLetter_ShouldReturnTrue()
    {
        // Arrange
        ArtistEntity artist = ArtistFactory.Create(name: "Beyonce", slug: "beyonce");
        var spec = new ArtistByInitialLetterSpecification(letter: "B");
    ...
    [Fact]
    public void ArtistByInitialLetterSpecification_WithDifferentLetter_ShouldReturnFalse()
    {
        // Arrange
        ArtistEntity artist = ArtistFactory.Create(name: "Beyonce", slug: "beyonce");
        var spec = new ArtistByInitialLetterSpecification(letter: "C");
    ...
    #region ArtistByFoldedNameSpecification

    [Fact]
    public void ArtistByFoldedNameSpecification_WithMatchingFragment_ShouldReturnTrue()
    {
        // Arrange
        ArtistEntity artist = ArtistFactory.Create(name: "Beyonce Knowles", slug: "beyonce-knowles");
        var spec = new ArtistByFoldedNameSpecification(search: "knowles");
    ...
    [Fact]
    public void ArtistByFoldedNameSpecification_WithAccentedFragment_ShouldReturnTrue()
    {
        // Arrange
        ArtistEntity artist = ArtistFactory.Create(name: "Beyonce Knowles", slug: "beyonce-knowles");
        var spec = new ArtistByFoldedNameSpecification(search: "Beyoncé");
    ...
    [Fact]
    public void ArtistByFoldedNameSpecification_WithUnrelatedFragment_ShouldReturnFalse()
    {
        // Arrange
        ArtistEntity artist = ArtistFactory.Create(name: "Beyonce Knowles", slug: "beyonce-knowles");
        var spec = new ArtistByFoldedNameSpecification(search: "rihanna");
