...
/// <summary>
/// Unit tests for <see cref="AdminDeactivatePackageResponse"/>.
/// </summary>
public class AdminDeactivatePackageEndpointV1Tests
{
    [Fact]
    public void AdminDeactivatePackageResponse_ShouldConstructCorrectly()
    {
        // Arrange
        PackageDto package = CreatePackageDto();

        // Act
        var response = new AdminDeactivatePackageResponse(Package: package);
