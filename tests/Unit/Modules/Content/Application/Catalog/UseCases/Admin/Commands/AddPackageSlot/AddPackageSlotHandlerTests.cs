...
/// <summary>
/// Unit tests for <see cref="AddPackageSlotHandler"/>.
/// </summary>
public class AddPackageSlotHandlerTests : BaseContentHandlerTest
{
    private readonly Mock<IPackageRepository> _packageRepositoryMock;
    private readonly Mock<ICategoryRepository> _categoryRepositoryMock;
    private readonly Mock<IContentUnitOfWork> _unitOfWorkMock;
    private readonly AddPackageSlotHandler _handler;

    public AddPackageSlotHandlerTests()
    {
        _packageRepositoryMock = MockPackageRepository.Create();
        _categoryRepositoryMock = MockCategoryRepository.Create();
        _unitOfWorkMock = MockContentUnitOfWork.Create();
        _handler = new AddPackageSlotHandler(
    ...
    public async Task Handle_WithCategoryId_ShouldAddSlotAndReturnPackage()
    {
        ...
        // Act
        AddPackageSlotResult result = await _handler.Handle(command, CancellationToken.None);
