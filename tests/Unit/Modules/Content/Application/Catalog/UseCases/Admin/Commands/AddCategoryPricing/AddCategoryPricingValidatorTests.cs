...
/// <summary>
/// Unit tests for <see cref="AddCategoryPricingValidator"/>.
/// </summary>
public class AddCategoryPricingValidatorTests
{
    private readonly AddCategoryPricingValidator _validator = new();
    ...
    public async Task Validate_WithEmptyCategoryId_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .Contain(e =>
                e.PropertyName == nameof(AddCategoryPricingCommand.CategoryId)
    ...
    public async Task Validate_WithEmptyPricingTierId_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .Contain(e =>
                e.PropertyName == nameof(AddCategoryPricingCommand.PricingTierId)
    ...
    public async Task Validate_WithNegativePriceUsd_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .Contain(e =>
                e.PropertyName == nameof(AddCategoryPricingCommand.PriceUsd)
