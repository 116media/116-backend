...
/// <summary>
/// Unit tests for <see cref="RemovePackageSlotHandler"/>.
/// </summary>
public class RemovePackageSlotHandlerTests : BaseContentHandlerTest
{
    private readonly Mock<IPackageRepository> _packageRepositoryMock;
    private readonly Mock<IContentUnitOfWork> _unitOfWorkMock;
    private readonly RemovePackageSlotHandler _handler;

    public RemovePackageSlotHandlerTests()
    {
        _packageRepositoryMock = MockPackageRepository.Create();
        _unitOfWorkMock = MockContentUnitOfWork.Create();
        _handler = new RemovePackageSlotHandler(_packageRepositoryMock.Object, _unitOfWorkMock.Object, Mapper);
    }
    ...
    public async Task Handle_WhenSlotExists_ShouldRemoveAndReturnUpdatedPackage()
    {
        ...
        // Act
        RemovePackageSlotResult result = await _handler.Handle(command, CancellationToken.None);
