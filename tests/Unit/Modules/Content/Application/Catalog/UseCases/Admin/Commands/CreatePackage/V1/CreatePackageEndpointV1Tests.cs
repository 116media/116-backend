...
/// <summary>
/// Unit tests for <see cref="CreatePackageResponse"/>.
/// </summary>
public class CreatePackageEndpointV1Tests
{
    [Fact]
    public void CreatePackageResponse_ShouldConstructCorrectly()
    {
        // Arrange
        PackageDto package = CreatePackageDto();

        // Act
        var response = new CreatePackageResponse(Package: package);
