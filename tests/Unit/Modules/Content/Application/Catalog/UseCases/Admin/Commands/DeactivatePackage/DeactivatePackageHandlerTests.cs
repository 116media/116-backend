...
/// <summary>
/// Unit tests for <see cref="DeactivatePackageHandler"/>.
/// </summary>
public class DeactivatePackageHandlerTests : BaseContentHandlerTest
{
    private readonly Mock<IPackageRepository> _packageRepositoryMock;
    private readonly Mock<IContentUnitOfWork> _unitOfWorkMock;
    private readonly DeactivatePackageHandler _handler;

    public DeactivatePackageHandlerTests()
    {
        _packageRepositoryMock = MockPackageRepository.Create();
        _unitOfWorkMock = MockContentUnitOfWork.Create();
        _handler = new DeactivatePackageHandler(_packageRepositoryMock.Object, _unitOfWorkMock.Object, Mapper);
    }
    ...
    public async Task Handle_WhenActive_ShouldDeactivateAndReturnDto()
    {
        ...
        // Act
        DeactivatePackageResult result = await _handler.Handle(command, CancellationToken.None);
