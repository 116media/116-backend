...
/// <summary>
/// Unit tests for <see cref="AdminGetCategoryByIdResponse"/>.
/// </summary>
public class AdminGetCategoryByIdEndpointV1Tests
{
    [Fact]
    public void AdminGetCategoryByIdResponse_ShouldConstructCorrectly()
    {
        // Arrange
        CategoryDto category = CreateCategoryDto();

        // Act
        var response = new AdminGetCategoryByIdResponse(Category: category);
