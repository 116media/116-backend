...
/// <summary>
/// Unit tests for <see cref="UpdateCustomerValidator"/>.
/// </summary>
public class UpdateCustomerValidatorTests
{
    ...
    public async Task Validate_WithEmptyId_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .Contain(e =>
                e.PropertyName == nameof(UpdateCustomerCommand.Id) && e.ErrorMessage == "Customer ID is required."
            );
    }
    ...
    public async Task Validate_WithEmptyFullName_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .Contain(e =>
                e.PropertyName == nameof(UpdateCustomerCommand.FullName)
