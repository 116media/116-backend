...
/// <summary>
/// Unit tests for <see cref="UpdateContentTypeHandler"/>.
/// </summary>
public class UpdateContentTypeHandlerTests : BaseContentHandlerTest
{
    ...
    public UpdateContentTypeHandlerTests()
    {
        ...
        _handler = new UpdateContentTypeHandler(_lookupRepositoryMock.Object, _unitOfWorkMock.Object, Mapper);
    }
    ...
    public async Task Handle_WhenEntityExists_ShouldUpdateAndReturnDto()
    {
        ...
        // Act
        UpdateContentTypeResult result = await _handler.Handle(command, CancellationToken.None);
