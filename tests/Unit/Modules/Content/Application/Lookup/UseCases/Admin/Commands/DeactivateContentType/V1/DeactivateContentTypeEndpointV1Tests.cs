...
/// <summary>
/// Unit tests for <see cref="DeactivateContentTypeResponse"/>.
/// </summary>
public class DeactivateContentTypeEndpointV1Tests
{
    [Fact]
    public void DeactivateContentTypeResponse_ShouldConstructCorrectly()
    {
        // Arrange
        ContentTypeDto contentType = CreateContentTypeDto();

        // Act
        var response = new DeactivateContentTypeResponse(ContentType: contentType);
