...
public class AdminUpdatePricingTierHandlerTests : BaseContentHandlerTest
{
    ...
    public AdminUpdatePricingTierHandlerTests()
    {
        ...
        _handler = new AdminUpdatePricingTierHandler(_lookupRepositoryMock.Object, _unitOfWorkMock.Object, Mapper);
    }
    ...
    public async Task Handle_WithNewName_ShouldUpdateAndReturnDto()
    {
        ...
        var command = new AdminUpdatePricingTierCommand(Id: existing.Id.ToString(), Name: newName, Description: null);
    ...
    public async Task Handle_WithSameName_ShouldAllowUpdateDespiteConflict()
    {
        ...
        var command = new AdminUpdatePricingTierCommand(Id: existing.Id.ToString(), Name: sameName, Description: null);
