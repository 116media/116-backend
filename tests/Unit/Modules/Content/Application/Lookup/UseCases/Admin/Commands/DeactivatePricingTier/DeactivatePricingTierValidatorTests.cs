...
/// <summary>
/// Unit tests for <see cref="DeactivatePricingTierValidator"/>.
/// </summary>
public class DeactivatePricingTierValidatorTests
{
    private readonly DeactivatePricingTierValidator _validator = new();
    ...
    public async Task Validate_WithEmptyGuid_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .ContainSingle(e =>
                e.PropertyName == nameof(DeactivatePricingTierCommand.Id)
