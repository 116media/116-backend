...
/// <summary>
/// Unit tests for <see cref="AdminUpdateContentTypeValidator"/>.
/// </summary>
public class AdminUpdateContentTypeValidatorTests
{
    ...
    {
        // Arrange
        var command = new AdminUpdateContentTypeCommand(Id: Guid.NewGuid().ToString(), Name: string.Empty);
    ...
    {
        // Arrange
        var command = new AdminUpdateContentTypeCommand(Id: "", Name: string.Empty);
