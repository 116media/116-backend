...
/// <summary>
/// Unit tests for <see cref="UpdatePricingTierValidator"/>.
/// </summary>
public class UpdatePricingTierValidatorTests
{
    private readonly UpdatePricingTierValidator _validator = new();
    ...
    public async Task Validate_WithEmptyId_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .ContainSingle(e =>
                e.PropertyName == nameof(UpdatePricingTierCommand.Id)
    ...
    public async Task Validate_WithEmptyName_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .ContainSingle(e =>
                e.PropertyName == nameof(UpdatePricingTierCommand.Name)
    ...
    public async Task Validate_WithEmptyIdAndName_ShouldHaveMultipleErrors()
    {
        ...
        // Assert
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(e => e.PropertyName == nameof(UpdatePricingTierCommand.Id));
        result.Errors.Should().Contain(e => e.PropertyName == nameof(UpdatePricingTierCommand.Name));
    }
