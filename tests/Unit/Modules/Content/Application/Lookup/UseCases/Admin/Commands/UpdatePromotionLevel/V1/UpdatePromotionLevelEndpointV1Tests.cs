...
/// <summary>
/// Unit tests for <see cref="UpdatePromotionLevelResponse"/>.
/// </summary>
public class UpdatePromotionLevelEndpointV1Tests
{
    [Fact]
    public void UpdatePromotionLevelResponse_ShouldConstructCorrectly()
    {
        // Arrange
        PromotionLevelDto promotionLevel = CreatePromotionLevelDto();

        // Act
        var response = new UpdatePromotionLevelResponse(PromotionLevel: promotionLevel);
