...
/// <summary>
/// Unit tests for <see cref="CreatePricingTierValidator"/>.
/// </summary>
public class CreatePricingTierValidatorTests
{
    private readonly CreatePricingTierValidator _validator = new();
    ...
    {
        // Arrange
        var command = new CreatePricingTierCommand(
    ...
    {
        // Arrange
        var command = new CreatePricingTierCommand(Name: string.Empty, Description: null);
        ...
        result
            .Errors.Should()
            .ContainSingle(e =>
                e.PropertyName == nameof(CreatePricingTierCommand.Name)
    ...
    {
        // Arrange
        var command = new CreatePricingTierCommand(Name: null!, Description: null);
    ...
    public async Task Validate_WithDescriptionExceedingMaxLength_ShouldHaveError()
    {
        ...
        result
            .Errors.Should()
            .ContainSingle(e =>
                e.PropertyName == nameof(CreatePricingTierCommand.Description)
