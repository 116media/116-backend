...
/// <summary>
/// Unit tests for <see cref="ActivatePromotionLevelResponse"/>.
/// </summary>
public class ActivatePromotionLevelEndpointV1Tests
{
    [Fact]
    public void ActivatePromotionLevelResponse_ShouldConstructCorrectly()
    {
        // Arrange
        PromotionLevelDto promotionLevel = CreatePromotionLevelDto();

        // Act
        var response = new ActivatePromotionLevelResponse(PromotionLevel: promotionLevel);
