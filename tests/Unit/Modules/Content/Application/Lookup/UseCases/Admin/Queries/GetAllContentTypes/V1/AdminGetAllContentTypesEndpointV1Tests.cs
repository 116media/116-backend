...
/// <summary>
/// Unit tests for <see cref="AdminGetAllContentTypesResponse"/>.
/// </summary>
public class AdminGetAllContentTypesEndpointV1Tests
{
    [Fact]
    public void AdminGetAllContentTypesResponse_ShouldConstructCorrectly()
    {
        // Arrange
        IReadOnlyList<ContentTypeDto> contentTypes = [CreateContentTypeDto(), CreateContentTypeDto()];

        // Act
        var response = new AdminGetAllContentTypesResponse(ContentTypes: contentTypes);
