...
/// </summary>
public class CreateTagHandlerTests : BaseContentHandlerTest
{
    ...
    public CreateTagHandlerTests()
    {
        ...
        _handler = new CreateTagHandler(_lookupRepositoryMock.Object, _unitOfWorkMock.Object, Mapper);
    }
    ...
    public async Task Handle_WhenSlugDoesNotExist_ShouldCreateAndReturnDto()
    {
        ...
        var command = new CreateTagCommand(Name: name, Slug: slug);
    ...
    public async Task Handle_WhenSlugAlreadyExists_ShouldThrowConflictException()
    {
        // Arrange
        string slug = TestConstants.Content.Tag.ValidSlug;
        var command = new CreateTagCommand(Name: TestConstants.Content.Tag.ValidName, Slug: slug);
