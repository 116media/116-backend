...
/// <summary>
/// Unit tests for <see cref="GetAllContentTypesHandler"/>.
/// </summary>
public class GetAllContentTypesHandlerTests : BaseContentHandlerTest
{
    private readonly Mock<ILookupRepository> _lookupRepositoryMock;
    private readonly GetAllContentTypesHandler _handler;

    public GetAllContentTypesHandlerTests()
    {
        _lookupRepositoryMock = MockLookupRepository.Create();
        _handler = new GetAllContentTypesHandler(_lookupRepositoryMock.Object, Mapper);
    }
    ...
    public async Task Handle_WithMultipleContentTypes_ShouldReturnAllMapped()
    {
        ...
        // Act
        GetAllContentTypesResult result = await _handler.Handle(query, CancellationToken.None);
