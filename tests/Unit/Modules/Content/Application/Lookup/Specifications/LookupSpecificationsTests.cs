...
public class LookupSpecificationsTests
{
    ...
    #region TagByNameSpecification — case-insensitive (ILike)
    ...
    public void TagByNameSpecification_WithMatchingName_ShouldReturnTrue()
    {
        ...
        // Act & Assert
        spec.IsSatisfiedInMemoryBy(tag).Should().BeTrue();
    }

    [Fact]
    public void TagByNameSpecification_WithDifferentCase_ShouldReturnTrue()
    {
        // Arrange
        TagEntity tag = TagFactory.CreateDefault();
        var spec = new TagByNameSpecification(tag.Name.ToUpperInvariant());
    ...
    public void TagByNameSpecification_WithDifferentName_ShouldReturnFalse()
    {
        ...
        // Act & Assert
        spec.IsSatisfiedInMemoryBy(tag).Should().BeFalse();
    }
