...
/// <summary>
/// Named aliases for <see cref="PackageBuilder" /> chains that three or more tests share verbatim.
...
public static class PackageFactory
{
    ...
    public static PackageEntity CreateDefault() =>
        new PackageBuilder().WithName(TestConstants.Package.ValidName).Build();
