...
public class AdminUpdatePromotionLevelRequestBuilder
{
    ...
    public AdminUpdatePromotionLevelRequestBuilder()
    {
        ...
        _name = candidate[..Math.Min(TestConstants.Content.PromotionLevel.NameMaxLength, candidate.Length)];
        _durationDays = TestConstants.Content.PromotionLevel.ValidDurationDays;
        _priceUsd = TestConstants.Content.PromotionLevel.ValidPriceUsd;
        _spotPriority = null;
    }
